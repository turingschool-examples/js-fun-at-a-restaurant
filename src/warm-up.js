...
var vegetables = ["Spinach", "Onion", "Broccoli", "Bell Pepper", "Kale"];
...
var fruits = ["Watermelon", "Pineapple", "Kiwi", "Apple", "Grapefruit", "Grapes", "Banana"];
...
//other K-V pairs could be:
//hours: "6AM - 12PM";
//location: "Denver"; (noticed the next question after answering lol)
//hasGasStation: true; etc.
