...
//changed to "inStock" to match the variable on line 5
function evaluateStockCount() {
  if (inStock >= 1) {
...
console.log(evaluateStockCount());
...
var vegetables = ['carrots', 'cucumber', 'lettuce', 'tomato', 'avocado'];
// Write the code to access the 3rd element of the Array, using bracket
// notation.
console.log(vegetables[2]);
// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ['apple', 'raspberry', 'blueberry', 'banana', 'orange', 'pear', 'plum'];
// Write the code to access the 5th element of the array, using bracket notation.
console.log(vegetables[4]);
//------------------------- Objects -------------------------//
// Create a new variable called "groceryStore" and assign to it an object literal with two // keys: name, and isOpen. The value for name should the string 'King Soopers' (or your favorite grocery store), and
...
//repl.it for this assigment https://repl.it/@SteveCalla/WeepyFickleLamp#index.js